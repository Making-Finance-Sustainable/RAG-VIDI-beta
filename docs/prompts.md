...
FRAMING_SALIENCE_PROMPT = PromptTemplate(
    template=(
        ...
        "Goal\n"
        "For each category that is PRESENT, you must estimate:\n"
        ...
        "- sentence_share MUST be an integer ≥ 0.\n"
        ...
        "  - sentence_share: integer ≥ 0 (number of sentences substantially about that category)\n"
...
REVIEW_FRAMING_PROMPT = PromptTemplate(
    template=(
        ...
        "You must ensure:\n"
        "- Keys cover ONLY categories marked present in the reviewed presence.\n"
        "- sentence_share are integers ≥ 0.\n"
